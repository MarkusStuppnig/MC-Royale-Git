...
public class WeaponStats {
	...
	public static Weapon ak47() {
		return new Weapon(Material.DIAMOND, ak47_display_name, 20, 2.3, 5F, 5F, 1, 1, 4);
	}
	
	public static Weapon pump() {
		return new Weapon(Material.EMERALD, pump_display_name, 6, 3.0, 1.5F, 50F, 200, 10, 5);
	}
	
	public static Weapon sniper() {
		return new Weapon(Material.IRON_INGOT, sniper_display_name, 6, 5.0, 12F, 0.02F, 1, 20, 22);
	}
}